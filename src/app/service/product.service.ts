...
export class ProductService {
  ...
  getElectronics(): Observable<Product[]> {
    return this.http
      .get<Product[]>(this.electronicsUrl)
      .pipe(catchError(this.handleError("getElectronics", [])));
  }
  getVideoGames(): Observable<Product[]> {
    return this.http
      .get<Product[]>(this.videogamesUrl)
      .pipe(catchError(this.handleError("getVideoGames", [])));
  }
  getMovies(): Observable<Product[]> {
    return this.http
      .get<Product[]>(this.moviessUrl)
